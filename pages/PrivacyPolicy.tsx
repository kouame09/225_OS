      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 sm:p-12 border border-slate-200 dark:border-slate-800">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <h3 className="text-lg font-bold text-slate-900 dark:text-white mt-8 mb-3">2. Data Collection & Authentication</h3>
            <p className="text-slate-600 dark:text-slate-300 mb-4 leading-relaxed">
              We collect and store the following data <strong>exclusively for authentication and platform functionality</strong>:
            </p>
            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mb-4 space-y-2">
              ...
              <li><strong>GitHub profile information</strong>: When you sign in with GitHub, we collect your GitHub username, profile picture, and email (if public)</li>
              <li><strong>Project data</strong>: Information about the open source projects you add to the platform</li>
              <li><strong>Theme preference</strong>: Your light/dark mode preference is stored locally in your browser</li>
            </ul>
            <p className="text-slate-600 dark:text-slate-300 mb-4 leading-relaxed">
              <strong>We do NOT</strong> use tracking cookies, third-party analytics for advertising, or sell your data to third parties. All data collected is used solely to provide and improve the 225 Open Source platform experience.
            </p>
